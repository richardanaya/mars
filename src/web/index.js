var F,M,I,G,N=globalThis.trustedTypes,Q=N?N.createPolicy("lit-html",{createHTML:o=>o}):void 0,g=`lit$${(Math.random()+"").slice(9)}$`,X="?"+g,Tt=`<${X}>`,w=document,E=(o="")=>w.createComment(o),L=o=>o===null||typeof o!="object"&&typeof o!="function",Y=Array.isArray,Ot=o=>{var t;return Y(o)||typeof((t=o)===null||t===void 0?void 0:t[Symbol.iterator])=="function"},_=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,tt=/-->/g,et=/>/g,b=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,it=/'/g,st=/"/g,ot=/^(?:script|style|textarea)$/i,Ht=o=>(t,...e)=>({_$litType$:o,strings:t,values:e}),f=Ht(1),S=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),rt=new WeakMap,Ut=(o,t,e)=>{var i,s;let n=(i=e==null?void 0:e.renderBefore)!==null&&i!==void 0?i:t,r=n._$litPart$;if(r===void 0){let h=(s=e==null?void 0:e.renderBefore)!==null&&s!==void 0?s:null;n._$litPart$=r=new C(t.insertBefore(E(),h),h,void 0,e)}return r.I(o),r},x=w.createTreeWalker(w,129,null,!1),jt=(o,t)=>{let e=o.length-1,i=[],s,n=t===2?"<svg>":"",r=_;for(let l=0;l<e;l++){let a=o[l],v,c,d=-1,m=0;for(;m<a.length&&(r.lastIndex=m,c=r.exec(a),c!==null);)m=r.lastIndex,r===_?c[1]==="!--"?r=tt:c[1]!==void 0?r=et:c[2]!==void 0?(ot.test(c[2])&&(s=RegExp("</"+c[2],"g")),r=b):c[3]!==void 0&&(r=b):r===b?c[0]===">"?(r=s??_,d=-1):c[1]===void 0?d=-2:(d=r.lastIndex-c[2].length,v=c[1],r=c[3]===void 0?b:c[3]==='"'?st:it):r===st||r===it?r=b:r===tt||r===et?r=_:(r=b,s=void 0);let j=r===b&&o[l+1].startsWith("/>")?" ":"";n+=r===_?a+Tt:d>=0?(i.push(v),a.slice(0,d)+"$lit$"+a.slice(d)+g+j):a+g+(d===-2?(i.push(void 0),l):j)}let h=n+(o[e]||"<?>")+(t===2?"</svg>":"");return[Q!==void 0?Q.createHTML(h):h,i]},$=class{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let n=0,r=0,h=t.length-1,l=this.parts,[a,v]=jt(t,e);if(this.el=$.createElement(a,i),x.currentNode=this.el.content,e===2){let c=this.el.content,d=c.firstChild;d.remove(),c.append(...d.childNodes)}for(;(s=x.nextNode())!==null&&l.length<h;){if(s.nodeType===1){if(s.hasAttributes()){let c=[];for(let d of s.getAttributeNames())if(d.endsWith("$lit$")||d.startsWith(g)){let m=v[r++];if(c.push(d),m!==void 0){let j=s.getAttribute(m.toLowerCase()+"$lit$").split(g),A=/([.?@])?(.*)/.exec(m);l.push({type:1,index:n,name:A[2],strings:j,ctor:A[1]==="."?nt:A[1]==="?"?lt:A[1]==="@"?at:T})}else l.push({type:6,index:n})}for(let d of c)s.removeAttribute(d)}if(ot.test(s.tagName)){let c=s.textContent.split(g),d=c.length-1;if(d>0){s.textContent=N?N.emptyScript:"";for(let m=0;m<d;m++)s.append(c[m],E()),x.nextNode(),l.push({type:2,index:++n});s.append(c[d],E())}}}else if(s.nodeType===8)if(s.data===X)l.push({type:2,index:n});else{let c=-1;for(;(c=s.data.indexOf(g,c+1))!==-1;)l.push({type:7,index:n}),c+=g.length-1}n++}}static createElement(t,e){let i=w.createElement("template");return i.innerHTML=t,i}};function P(o,t,e=o,i){var s,n,r,h;if(t===S)return t;let l=i!==void 0?(s=e.\u03A3i)===null||s===void 0?void 0:s[i]:e.\u03A3o,a=L(t)?void 0:t._$litDirective$;return(l==null?void 0:l.constructor)!==a&&((n=l==null?void 0:l.O)===null||n===void 0||n.call(l,!1),a===void 0?l=void 0:(l=new a(o),l.T(o,e,i)),i!==void 0?((r=(h=e).\u03A3i)!==null&&r!==void 0?r:h.\u03A3i=[])[i]=l:e.\u03A3o=l),l!==void 0&&(t=P(o,l.S(o,t.values),l,i)),t}var ht=class{constructor(t,e){this.l=[],this.N=void 0,this.D=t,this.M=e}u(t){var e;let{el:{content:i},parts:s}=this.D,n=((e=t==null?void 0:t.creationScope)!==null&&e!==void 0?e:w).importNode(i,!0);x.currentNode=n;let r=x.nextNode(),h=0,l=0,a=s[0];for(;a!==void 0;){if(h===a.index){let v;a.type===2?v=new C(r,r.nextSibling,this,t):a.type===1?v=new a.ctor(r,a.name,a.strings,this,t):a.type===6&&(v=new ct(r,this,t)),this.l.push(v),a=s[++l]}h!==(a==null?void 0:a.index)&&(r=x.nextNode(),h++)}return n}v(t){let e=0;for(let i of this.l)i!==void 0&&(i.strings!==void 0?(i.I(t,i,e),e+=i.strings.length-2):i.I(t[e])),e++}},C=class{constructor(t,e,i,s){this.type=2,this.N=void 0,this.A=t,this.B=e,this.M=i,this.options=s}setConnected(t){var e;(e=this.P)===null||e===void 0||e.call(this,t)}get parentNode(){return this.A.parentNode}get startNode(){return this.A}get endNode(){return this.B}I(t,e=this){t=P(this,t,e),L(t)?t===u||t==null||t===""?(this.H!==u&&this.R(),this.H=u):t!==this.H&&t!==S&&this.m(t):t._$litType$!==void 0?this._(t):t.nodeType!==void 0?this.$(t):Ot(t)?this.g(t):this.m(t)}k(t,e=this.B){return this.A.parentNode.insertBefore(t,e)}$(t){this.H!==t&&(this.R(),this.H=this.k(t))}m(t){let e=this.A.nextSibling;e!==null&&e.nodeType===3&&(this.B===null?e.nextSibling===null:e===this.B.previousSibling)?e.data=t:this.$(w.createTextNode(t)),this.H=t}_(t){var e;let{values:i,_$litType$:s}=t,n=typeof s=="number"?this.C(t):(s.el===void 0&&(s.el=$.createElement(s.h,this.options)),s);if(((e=this.H)===null||e===void 0?void 0:e.D)===n)this.H.v(i);else{let r=new ht(n,this),h=r.u(this.options);r.v(i),this.$(h),this.H=r}}C(t){let e=rt.get(t.strings);return e===void 0&&rt.set(t.strings,e=new $(t)),e}g(t){Y(this.H)||(this.H=[],this.R());let e=this.H,i,s=0;for(let n of t)s===e.length?e.push(i=new C(this.k(E()),this.k(E()),this,this.options)):i=e[s],i.I(n),s++;s<e.length&&(this.R(i&&i.B.nextSibling,s),e.length=s)}R(t=this.A.nextSibling,e){var i;for((i=this.P)===null||i===void 0||i.call(this,!1,!0,e);t&&t!==this.B;){let s=t.nextSibling;t.remove(),t=s}}},T=class{constructor(t,e,i,s,n){this.type=1,this.H=u,this.N=void 0,this.V=void 0,this.element=t,this.name=e,this.M=s,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this.H=Array(i.length-1).fill(u),this.strings=i):this.H=u}get tagName(){return this.element.tagName}I(t,e=this,i,s){let n=this.strings,r=!1;if(n===void 0)t=P(this,t,e,0),r=!L(t)||t!==this.H&&t!==S,r&&(this.H=t);else{let h=t,l,a;for(t=n[0],l=0;l<n.length-1;l++)a=P(this,h[i+l],e,l),a===S&&(a=this.H[l]),r||(r=!L(a)||a!==this.H[l]),a===u?t=u:t!==u&&(t+=(a??"")+n[l+1]),this.H[l]=a}r&&!s&&this.W(t)}W(t){t===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},nt=class extends T{constructor(){super(...arguments),this.type=3}W(t){this.element[this.name]=t===u?void 0:t}},lt=class extends T{constructor(){super(...arguments),this.type=4}W(t){t&&t!==u?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name)}},at=class extends T{constructor(){super(...arguments),this.type=5}I(t,e=this){var i;if((t=(i=P(this,t,e,0))!==null&&i!==void 0?i:u)===S)return;let s=this.H,n=t===u&&s!==u||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,r=t!==u&&(s===u||n);n&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,t),this.H=t}handleEvent(t){var e,i;typeof this.H=="function"?this.H.call((i=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&i!==void 0?i:this.element,t):this.H.handleEvent(t)}},ct=class{constructor(t,e,i){this.element=t,this.type=6,this.N=void 0,this.V=void 0,this.M=e,this.options=i}I(t){P(this,t)}};(M=(F=globalThis).litHtmlPlatformSupport)===null||M===void 0||M.call(F,$,C),((I=(G=globalThis).litHtmlVersions)!==null&&I!==void 0?I:G.litHtmlVersions=[]).push("2.0.0-rc.2");var z=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,B=Symbol(),R=class{constructor(t,e){if(e!==B)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return z&&this.t===void 0&&(this.t=new CSSStyleSheet,this.t.replaceSync(this.cssText)),this.t}toString(){return this.cssText}},At=o=>new R(o+"",B),dt=new Map,k=(o,...t)=>{let e=t.reduce((s,n,r)=>s+(h=>{if(h instanceof R)return h.cssText;if(typeof h=="number")return h;throw Error(`Value passed to 'css' function must be a 'css' function result: ${h}. Use 'unsafeCSS' to pass non-literal values, but
    ...
    </div>`}firstUpdated(){this.editorView=new $t({state:Wt.create({doc:'println!("hello");',extensions:[Zt,Pt.of([{key:"Ctrl-Enter",run:()=>{this.runCodeCell()}}]),Pt.of([Jt]),Kt(),Qt,Gt]}),parent:this.querySelector(".code-cell-editor")}),U(document.querySelector("#run-all")).addEventListener("click",()=>this.runCodeCell())}async load_result(o){let t=0;for(;;){if(t>60)return;let e=await fetch(`http://127.0.0.1:8080/notebook/${H()}/result/`+o).then(i=>i.json());if(console.log(e),e==null)await xt(1e3);else{U(this.querySelector(".code-cell-output")).innerHTML=e.result;return}t++}}async runCodeCell(){U(this.querySelector(".code-cell-output")).innerHTML="Processing...";let o=await fetch(`http://127.0.0.1:8080/notebook/${H()}/execute`,{method:"POST",body:U(this.editorView).state.doc.toString()}).then(t=>t.text());this.load_result(parseFloat(o))}};Et=qt([y("code-cell")],Et);var Xt=Object.defineProperty,Yt=Object.getOwnPropertyDescriptor,te=(o,t,e,i)=>{for(var s=i>1?void 0:i?Yt(t,e):t,n=o.length-1,r;n>=0;n--)(r=o[n])&&(s=(i?r(t,e,s):r(s))||s);return i&&s&&Xt(t,e,s),s},_t=class extends p{static get styles(){return k`
      .cpus {
        display: grid;
    ...
    `}render(){return f`<div class="cpus">
      ...
      <div class="cpu">1</div>
      <div class="cpu">2</div>
    </div>`}};_t=te([y("cpu-info")],_t);document.querySelector("#add-cell")?.addEventListener("click",()=>{document.querySelector(".notebook")?.appendChild(document.createElement("code-cell"))});
/**
 * @license
